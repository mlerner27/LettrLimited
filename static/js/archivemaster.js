...
function renderListingsFull(L_id, img, address, neighborhood, apartment_type, date, prices) {
    ...
    var trash_full = $("<div class='ellipse-parent3'>")
    var trash_button = $("<button class='trash_button_archive' value = '" + L_id + "'>")
    var trash_wrapper = $("<div class='group-child3'>")
    var trash_icon = $("<img class='icons8-bookmark-96-3-11' src='../static/img/icons8trash60-1@2x.png'>")

    var saved_full = $("<div class='ellipse-parent4'>")
    var saved_button = $("<button class='save_button_archive' value = '" + L_id + "'>")
    ...
    $(trash_wrapper).append(trash_icon)
    $(trash_button).append(trash_wrapper)
    $(trash_full).append(trash_button)
    $(".swipe-3-mas").append(trash_full)
...
$(document).ready(function(){
    ...
    $(".save_button_archive").click(function(){
        var L_id = $(".save_button_archive").val()
        saveListings(L_id, data, "archive")
    })

    $(".trash_button_archive").click(function(){
        var L_id = $(".trash_button_archive").val()
        trashListing(L_id, data)
    })
})